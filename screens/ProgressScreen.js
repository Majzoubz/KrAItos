    ...
    <SafeAreaView style={s.safeArea}>
      ...
      <ScrollView contentContainerStyle={s.scroll}>
        ...
        <View style={s.statsGrid}>
          {STATS.map((st, i) => (
            <View key={i} style={[s.statCard, { borderLeftColor: st.color }, i % 2 === 0 ? { marginRight: 12 } : {}]}>
...
const s = StyleSheet.create({
  ...
  statCard: { width: CARD_W, backgroundColor: C.card, borderRadius: 14, padding: 16, borderLeftWidth: 4, marginBottom: 12 },
  ...
  comingSoon: { backgroundColor: C.card, borderRadius: 16, padding: 16, borderLeftWidth: 3, borderLeftColor: C.green },
