...
const s = StyleSheet.create({
  ...
  name: { color: C.white, fontSize: 22, fontWeight: '900', marginTop: 2, letterSpacing: 0.5 },
  ...
  statsBar: { flexDirection: 'row', marginHorizontal: 20, backgroundColor: C.surface, borderRadius: 18, padding: 16, marginBottom: 16, justifyContent: 'space-around', alignItems: 'center', borderWidth: 1, borderColor: C.border },
  ...
  onboardCard: { marginHorizontal: 20, marginBottom: 16, backgroundColor: C.card, borderRadius: 18, padding: 18, borderWidth: 1, borderColor: C.border },
  ...
  planBanner: { marginHorizontal: 20, marginBottom: 16, backgroundColor: C.green + '12', borderRadius: 14, padding: 16, borderLeftWidth: 3, borderLeftColor: C.green },
  planBannerText: { color: C.green, fontSize: 13, fontWeight: '600' },
  waterCard: { marginHorizontal: 20, marginBottom: 16, backgroundColor: C.card, borderRadius: 18, padding: 18, borderWidth: 1, borderColor: C.border },
  ...
  glass: { flex: 1, height: 24, borderRadius: 8, backgroundColor: C.surface, marginRight: 4, borderWidth: 1, borderColor: C.border },
  glassFilled: { backgroundColor: C.green, borderColor: C.green },
  waterBtn: { backgroundColor: C.greenGlow, paddingVertical: 12, borderRadius: 12, alignItems: 'center' },
  waterBtnText: { color: C.green, fontWeight: '800', fontSize: 13 },
  streakBanner: { marginHorizontal: 20, marginBottom: 16, backgroundColor: C.green + '12', borderRadius: 14, padding: 16, borderLeftWidth: 3, borderLeftColor: C.green },
  streakBannerText: { color: C.green, fontSize: 13, fontWeight: '600' },
  sectionTitle: { color: C.white, fontSize: 16, fontWeight: '800', marginHorizontal: 20, marginBottom: 12, letterSpacing: 0.5 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', paddingHorizontal: 20 },
  card: { width: CARD_W, backgroundColor: C.card, borderRadius: 18, padding: 18, borderTopWidth: 3, marginBottom: 12, borderWidth: 1, borderColor: C.border },
