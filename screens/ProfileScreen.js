...
const s = StyleSheet.create({
  ...
  statCard: { flex: 1, backgroundColor: C.card, borderRadius: 16, padding: 16, alignItems: 'center', marginRight: 8, borderTopWidth: 3, borderWidth: 1, borderColor: C.border },
  ...
  infoTitle: { color: C.green, fontWeight: '800', fontSize: 13, marginBottom: 14, letterSpacing: 1 },
  ...
  logoutBtn: { borderWidth: 1.5, borderColor: C.danger, paddingVertical: 16, borderRadius: 16, alignItems: 'center', marginTop: 20 },
