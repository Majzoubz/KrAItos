...
const AUTHED = ['home', 'scanner', 'foodlog', 'plan', 'tracker', 'ar', 'profile', 'settings', 'progress', 'health', 'mealstudio', 'workoutsession', 'barcode', 'weeklyreview', 'measurements', 'coach', 'grocery', 'restaurant'];
